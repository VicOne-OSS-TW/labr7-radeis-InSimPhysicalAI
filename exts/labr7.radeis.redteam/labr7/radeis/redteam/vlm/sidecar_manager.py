...
class SidecarManager:
    ...
    def _push_carb_setting(self):
        try:
            ...
            carb.settings.get_settings().set(
                "/exts/labr7.radeis.redteam/sidecar_url", self._active_url)
        except Exception:  # noqa: BLE001
            pass
    ...
    def spawn_tray(self):
        ...
        tray_script = os.path.join(
            self._ext_path,
            "labr7", "radeis", "redteam", "vlm", "tray_agent_launcher.py")
...
def _find_server_py(ext_path: str) -> str:
    ...
    candidates = [
        ...
        # Dev tree: ext root is labr7.radeis.redteam/, 4 levels up = repo root
